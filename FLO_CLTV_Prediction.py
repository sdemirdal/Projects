...
df_ = pd.read_csv(r"C:\Users\berkt\Documents\VBO Egitim\DSMBLC9\Modul2_CRMAnalitiği\flo_data_20k.csv")
df = df_.copy()
df.head()
...
"""
2.YONTEM
cltv_df["recency"] = (df["last_order_date"] - df["first_order_date"])/ dt.timedelta(weeks = 1)
cltv_df["T"] = (today_date - df["first_order_date"]) / dt.timedelta(weeks = 1)
cltv_df["monetary_cltv_avg"] = df["customer_value_total"] / df["order_num_total"]
"""
